...
<body>
    ...
    <div class="card" style="margin: 20px;">
        ...
        <div class="card-body">
            <p>Cari data buku :</p>
            <form action="tampil_buku.php" method="POST" style="padding-bottom: 15px;" class="d-flex">
            ...
            <a class="btn btn-secondary" href="tambah_buku.php" role="button">Tambahkan Buku</a>
            <hr>
            <table class="table">
                <thead>
                    <tr>
